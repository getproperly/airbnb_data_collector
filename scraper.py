...
class AirbnbScraper:
    ...
    def listing_url(self, price_min,price_max,offset):
        return ('https://m.airbnb.com/api/-/v1/listings/search?location=San-Francisco--CA--United-States&price_min=%s&price_max=%s&number_of_guests=1&offset=%s&guests=1&items_per_page=20'
